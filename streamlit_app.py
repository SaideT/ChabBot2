...
st.set_page_config(page_title="Chatbot GPT-3.5 Turbo", page_icon="🦙", layout="centered", initial_sidebar_state="auto", menu_items=None)
...
# Function to get the GPT-3.5's response
